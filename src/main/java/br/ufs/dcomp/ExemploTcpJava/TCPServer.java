...
public class TCPServer{
    public static void main(String[] args){
        ...
        try {
            ...
            System.out.print("[ Server: Aguardando recebimento de mensagem   ..............  ");
            ...
            //ALTERADO
            String inMsg = "Tudo bem?";
            byte[] inBuf = inMsg.getBytes(); // Obtendo a respresentação em bytes da mensagem

            System.out.print("[  Server: Enviando mensagem    ..............................  ");
            os.write(inBuf);
            System.out.println("[OK] ]");
